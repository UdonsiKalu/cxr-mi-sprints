# Curriculum — notebook tables

High-level home: [`README.md`](README.md). Start: [`notebooks/00_START_HERE.ipynb`](notebooks/00_START_HERE.ipynb).
...
Executable now: 1–6 and 9. Stubs (not in `look.py` yet): 7–8 and 10–13.
